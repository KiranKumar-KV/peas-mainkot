...
export default class HCHeader extends Component {
 ...
 async componentWillReceiveProps()
 {
  ...
  async get()
  {
    ...
    {
        floor=await axios.get(API_URL+"/hms/kot/getFloor");
        let floors=await floor.data.filter(data=>{
            return data.floor_name.toLowerCase()!=='room'
       })
       await this.setState({
           floor:floors
       })
    ...
    {
        floor=await axios.get(API_URL+"/hms/kot/getFloorTakeaway");
        let floors=await floor.data.filter(data=>{
            return data.floor_name.toLowerCase()!=='room'
       })
       await this.setState({
