...
export default class MenuContHeader extends Component {
    ...
    handleFilterSearch(search,filter)
    {
    ...
    {
        kotAdd((err, message) => {
            if(message==="item_update" ||  message==='menu_update')
            {
               this.get();
            }
        }) 
                    ...
                    <div className="filterButton">
                        <ButtonToolbar>
                            ...
                            >
                                ...
                                <MenuItem eventKey="available" onSelect={this.handleFilter.bind(this)} >Available</MenuItem>
                        ...
                        return(
                            <div>
                                <Button className={"availItem"+" "+menu.mbool}
                                    ...
                                    checked={menu.mbool}
                                    onClick={this.handleSwitch.bind(this,menu.mbool,menu.status_id)}>
                                    {menu.menu_name}
                                </Button>
                            </div>
                        )
