...
export default class FoodMenuItemList extends Component {
    ...
    handleSwitchItem(e)
    {
        if(this.state.item_switch)
        {
            // this.setState({
            //     item_switch:false
            // })
            this.props.handleSwitchItem(true,this.props.item_id);
        }
        else
        {
            // this.setState({
            //     item_switch:true
            // })
            this.props.handleSwitchItem(false,this.props.item_id);
        }
        ...
        return (
            <tr>
                ...
                <td className="center">
                    ...
                    // onClick={this.handleSwitchItem.bind(this)}
