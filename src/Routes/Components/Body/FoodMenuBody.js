...
export default class FoodMenuBody extends Component {
    ...
    {
       await this.get();
        await this.loadItems(this.state.menu);
   ...
   async handleSearch(e,filter_item)
    {
       await this.setState({
            filter_data_search:e,
            filter_data_drop:filter_item
        })
       await this.ViewItemsSort(filter_item);
    ...
    { 
        try
        {
            ...
            await this.handleFilter(this.state.filter_data_drop);
           await this.handleSearch(this.state.filter_data_search,this.state.filter_data_drop);
        }
        catch(error)
        {
            this.setState({
    ...
    {
        // alert("dfdf");
        // this.props.handleFilterSearch(this.state.filter_data_search,this.state.filter_data_drop);
    ...
    render()
    {
        return (
            <div> 
                <FoodMenuHeader  handleSearch={this.handleSearch.bind(this)} 
