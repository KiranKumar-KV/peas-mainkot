                    ...
                    >
                        ...
                        { 
                            this.props.items.map((i,index)=>{
                                return(
                                    <KOTBillnext handleCancelOrder={this.handleCancelOrder.bind(this)} tax={this.props.tax} kot_id={i.kot_id} items={i.items} index={this.props.items.length-index} order_status={i.order_status} kitchen_status={i.kitchen_order_status} bill_status={i.kot_bill_status}/>
                                )
                            })
                        }
                    </PanelGroup>
