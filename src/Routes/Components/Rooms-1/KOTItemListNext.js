...
export default class KOTItemListNext extends Component {
    ...
    addOptions()
    {
        ...
        else if(this.props.type_name!=='Hotdrink' && this.props.kitchen_status!=='finish' && this.props.kitchen_status!=='close' && this.props.bill_status!=='Billed')
        {
            return(
                <div  className="KOTItemButton">
        ...
        else if(this.props.type_name==='Hotdrink' && this.props.order_status!=='close' && this.props.order_status!=='finish' && this.props.bill_status!=='Billed' )
        {
            return(
                <div className="KOTItemButton">
                    <span onClick={this.handleCancelOrder.bind(this)}>
