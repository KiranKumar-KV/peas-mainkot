                                                ...
                                                {this.state.menu.map((data,key)=>{
                                                    return(
                                                        <tr>
                                                            ...
                                                            <th  className="spliticons">
                                                                <Icon size={21} 
                                                                    icon={ic_mode_edit} 
                                                                    onClick={this.handleShow.bind(this,data.menu_name)}/> 
                                                            </th>
                                                                                ...
                                                                                <Col sm={10}>
                                                                                    <FormGroup validationState={this.state.new_menu_name.valid ? "success" : "error" }>
                                                                                        <FormControl type="text" 
                                                                                            id="new_menu_name" 
                                                                                            name="new_menu_name" 
                                                                                            value={this.state.new_menu_name.value} 
                                                                                            /*onKeyDownCapture={this.handleModalEnterCall.bind(this)}*/ 
                                                            ...
                                                            <th  className="deleteicons" >
                                                                <Icon size={21} icon={ic_delete}  
                                                                    onClick={this.Deletefunc.bind(this,data.menu_name)}
                                                                /> 
                                                            </th>
                                                        </tr>
                                                    )
                                        ...
                                        <th className="center" style={{width : "80%"}}>
                                            <FormGroup validationState={this.state.menu_name.valid ? "success" : "error" }>
                                                <FormControl type="text" 
                                                    id="menu_name"   
                                                    name="menu_name" 
                                                    value={this.state.menu_name.value} 
                                                    onKeyDownCapture={this.handleEnterCall.bind(this)} 
